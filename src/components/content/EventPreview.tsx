...
export const EventPreview: React.FC<EventPreviewProps> = ({
  ...
  if (isFeatured) {
    return (
      <div className="border border-warm-200 dark:border-gray-800 bg-white dark:bg-gray-900 rounded-lg p-6 lg:p-8 flex flex-col lg:flex-row gap-8 items-stretch shadow-xs">
        <div className="flex-1 flex flex-col justify-between space-y-6">
          <div>
            ...
            {description && (
              <p className="text-sm text-warm-400 dark:text-gray-400 leading-relaxed line-clamp-3 mb-4 font-sans">
                {description}
              </p>
            )}
          </div>
