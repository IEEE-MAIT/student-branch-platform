...
/**
 * Chapter Social Media Links Component.
...
export const ChapterSocialLinks: React.FC<ChapterSocialLinksProps> = ({
  ...
  const linkClass =
    size === 'sm'
      ? 'inline-flex items-center text-warm-300 hover:text-ieee-blue transition-colors duration-150'
      : 'inline-flex items-center gap-1.5 text-xs text-warm-400 hover:text-ieee-blue transition-colors duration-150 font-medium';
